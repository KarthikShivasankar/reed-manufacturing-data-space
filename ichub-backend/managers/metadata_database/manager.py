...
class RepositoryManager:
    ...
    def __init__(self, session: Session):
        ...
        # REED Manufacturing Data Space repositories
        self._reed_asset_classification_repository = None
        self._reed_policy_template_repository = None
        self._reed_supply_chain_relation_repository = None
        self._reed_access_request_repository = None
        self._reed_audit_event_repository = None
    ...
    @property
    def reed_asset_classification_repository(self):
        """Lazy initialization of the REED asset classification repository."""
        if self._reed_asset_classification_repository is None:
            from managers.metadata_database.reed_repositories import ReedAssetClassificationRepository
            self._reed_asset_classification_repository = ReedAssetClassificationRepository(self._session)
        return self._reed_asset_classification_repository

    @property
    def reed_policy_template_repository(self):
        """Lazy initialization of the REED policy template repository."""
        if self._reed_policy_template_repository is None:
            from managers.metadata_database.reed_repositories import ReedPolicyTemplateRepository
            self._reed_policy_template_repository = ReedPolicyTemplateRepository(self._session)
        return self._reed_policy_template_repository

    @property
    def reed_supply_chain_relation_repository(self):
        """Lazy initialization of the REED supply-chain relation repository."""
        if self._reed_supply_chain_relation_repository is None:
            from managers.metadata_database.reed_repositories import ReedSupplyChainRelationRepository
            self._reed_supply_chain_relation_repository = ReedSupplyChainRelationRepository(self._session)
        return self._reed_supply_chain_relation_repository

    @property
    def reed_access_request_repository(self):
        """Lazy initialization of the REED access request repository."""
        if self._reed_access_request_repository is None:
            from managers.metadata_database.reed_repositories import ReedAccessRequestRepository
            self._reed_access_request_repository = ReedAccessRequestRepository(self._session)
        return self._reed_access_request_repository

    @property
    def reed_audit_event_repository(self):
        """Lazy initialization of the REED audit event repository."""
        if self._reed_audit_event_repository is None:
            from managers.metadata_database.reed_repositories import ReedAuditEventRepository
            self._reed_audit_event_repository = ReedAuditEventRepository(self._session)
        return self._reed_audit_event_repository
