...
// REED Manufacturing Data Space feature modules
import { reedClassificationFeature } from './reed-kit/data-classification/routes';
import { reedPolicyTemplatesFeature } from './reed-kit/policy-templates/routes';
import { reedAccessRequestsFeature } from './reed-kit/access-requests/routes';
import { reedAuthorizationFeature } from './reed-kit/authorization/routes';
import { reedAuditFeature } from './reed-kit/audit/routes';
...
export const kits: KitFeature[] = [
  ...
  {
    id: 'reed',
    name: i18n.t('reed.name', { ns: 'kits', defaultValue: 'REED Manufacturing Data Space' }),
    description: i18n.t('reed.description', {
      ns: 'kits',
      defaultValue: 'Domain-specific manufacturing data space layer: data classification, policy catalogue, context-based authorization, access-request workflow and audit.',
    }),
    status: 'available',
    icon: <AccountTree />,
    image: DataGovernanceKitImage,
    features: [
      {
        module: reedClassificationFeature,
        id: 'reed-classification',
        name: i18n.t('reed.features.classification.name', { ns: 'kits', defaultValue: 'Data Classification' }),
        description: i18n.t('reed.features.classification.description', { ns: 'kits', defaultValue: 'DMP-derived data classification matrix' }),
        icon: <Policy />,
        enabled: true,
        default: false,
      },
      {
        module: reedPolicyTemplatesFeature,
        id: 'reed-policy-templates',
        name: i18n.t('reed.features.policyTemplates.name', { ns: 'kits', defaultValue: 'Policy Templates' }),
        description: i18n.t('reed.features.policyTemplates.description', { ns: 'kits', defaultValue: 'Catalogue/contract/usage policies and EDC/ODRL rendering' }),
        icon: <Gavel />,
        enabled: true,
        default: false,
      },
      {
        module: reedAccessRequestsFeature,
        id: 'reed-access-requests',
        name: i18n.t('reed.features.accessRequests.name', { ns: 'kits', defaultValue: 'Access Requests' }),
        description: i18n.t('reed.features.accessRequests.description', { ns: 'kits', defaultValue: 'Consumer access-request workflow' }),
        icon: <Inbox />,
        enabled: true,
        default: false,
      },
      {
        module: reedAuthorizationFeature,
        id: 'reed-authorization',
        name: i18n.t('reed.features.authorization.name', { ns: 'kits', defaultValue: 'Authorization Simulator' }),
        description: i18n.t('reed.features.authorization.description', { ns: 'kits', defaultValue: 'Context-based authorization evaluation' }),
        icon: <VerifiedUser />,
        enabled: true,
        default: false,
      },
      {
        module: reedAuditFeature,
        id: 'reed-audit',
        name: i18n.t('reed.features.audit.name', { ns: 'kits', defaultValue: 'Audit Trail' }),
        description: i18n.t('reed.features.audit.description', { ns: 'kits', defaultValue: 'Data-space activity audit trail' }),
        icon: <Timeline />,
        enabled: true,
        default: false,
      },
    ...
    domain: 'supply-chain',
    documentation: 'https://github.com/eclipse-tractusx/industry-core-hub/blob/main/docs/reed/README.md',
  }
];
